            ...
            sceneModels.forEach((sceneModel) => {
                ...
                this._dirtyMap[sceneModel.id].forEach((value, key) => {
                    ...
                    if(!this._verticesMap[sceneModel.id].has(key)) {
                        ...
                        this._verticesMap[sceneModel.id].set(key, vertices);
                        this._indicesMap[sceneModel.id].set(key, indices);
                    }
                    else {
                        vertices = this._verticesMap[sceneModel.id].get(key);
                        indices = this._indicesMap[sceneModel.id].get(key);
                    }
                    ...
                    if (capSegments.length > 0) {
                        unsortedSegments.set(key, capSegments);
                    }
                })
                //#endregion
                ...
                unsortedSegments.forEach((value, key) => {
                ...
                orderedSegments.forEach((value, key) => {
                    const arr = [];
                    for (let i = 0; i < value.length; i++) {
                        arr.push([]);
                ...
                geometryData.forEach((value, key) => {
